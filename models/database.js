...
function getUserData(user_id) {
   ...
   let query ="SELECT t.topic_name, t.description FROM topic t, user u  WHERE u.region_one = t.region  OR u.region_two = t.region  OR u.region_three = t.region AND u.user_id = $1"
   let values = [user_id]
